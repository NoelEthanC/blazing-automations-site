...
import { updateSiteContentAction } from "@/app/actions/content"
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400">Update your website content and settings.</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="bg-gray-800 border-gray-700">
          <TabsTrigger value="hero" className="data-[state=active]:bg-[#3f79ff]">
            Hero Section
          </TabsTrigger>
          <TabsTrigger value="services" className="data-[state=active]:bg-[#3f79ff]">
            Services
          </TabsTrigger>
          <TabsTrigger value="about" className="data-[state=active]:bg-[#3f79ff]">
            About
          </TabsTrigger>
          <TabsTrigger value="contact" className="data-[state=active]:bg-[#3f79ff]">
            Contact
          </TabsTrigger>
        </TabsList>
          ...
          <TabsContent value="services" className="space-y-6">
            <Card className="bg-gray-800/50 border-gray-700">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="services-description" className="text-gray-300">
                    Description
                  </Label>
                  <Textarea
