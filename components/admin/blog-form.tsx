...
export function BlogForm({ post }: BlogFormProps) {
  ...
  const handleSubmit = async (formData: FormData) => {
    startTransition(async () => {
      try {
        const result = post ? await updateBlogPost(post.id, null, formData) : await createBlogPost(null, formData)
    ...
    <form action={handleSubmit} className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Write your article content in HTML or Markdown..."
                />
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch id="featured" name="featured" defaultChecked={post?.featured} />
              </div>
              ...
              <div>
                ...
                <Select name="category" defaultValue={post?.category} required>
                  ...
                  <SelectContent className="bg-gray-800 border-gray-700">
                    <SelectItem value="TUTORIALS_GUIDES">Tutorials & Guides</SelectItem>
                    <SelectItem value="CASE_STUDIES">Case Studies</SelectItem>
                    <SelectItem value="SYSTEM_PROMPTS">System Prompts</SelectItem>
                  </SelectContent>
                </Select>
              </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-gray-700">
        ...
        <div className="flex items-center gap-3">
          <Button type="submit" disabled={isPending} className="bg-[#3f79ff] hover:bg-[#3f79ff]/80">
            {isPending ? (
              "Saving..."
            ) : (
              <>
