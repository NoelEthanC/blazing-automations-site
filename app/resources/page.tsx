        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredResources.length > 0 && (
            <div className="flex justify-center items-center space-x-4 mt-16">
              <Button variant="outline" size="sm" disabled className="border-gray-600 text-gray-500 bg-transparent">
                ← Previous
              </Button>
              <div className="flex space-x-2">
                <Button size="sm" className="bg-[#3f79ff] hover:bg-[#3f79ff]/80 text-white">
                  1
                </Button>
              </div>
              <Button variant="outline" size="sm" disabled className="border-gray-600 text-gray-500 bg-transparent">
